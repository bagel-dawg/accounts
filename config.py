...
class Config(object):
    ...
    LDAP_ARCHIVED_GROUP = os.environ.get('LDAP_ARCHIVED_GROUP') or ''
    ...
    COMPANY_HOMEPAGE = os.environ.get('COMPANY_HOMEPAGE') or ''
    SUPPORT_EMAIL = os.environ.get('SUPPORT_EMAIL') or ''